...
const Third = () => {
  return (
    <div
      className="grid justify-center items-center px-[28px] text-start mb-[30px] mt-[52px]  md:px-[55px] md:mt-[50px] 
    ...
    >
      ...
      <div className="">
        <p className="text-[white] md:w-[99%] w-[99%] xl:w-[54%] xl:mt-[25px] xl:tracking-[0.038em] lg:w-[70%] lg:tracking-[0.035em] text-[1em] leading-[1.9] md:tracking-[0.037em] tracking-[0.035em]  font-light mt-[13px]">
