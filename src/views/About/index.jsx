...
const About = () => {
  return (
    <div className='grid justify-center items-center px-[10px] md:mt-[40px] lg:mt-[62px] xl:px-[85px] xl:mt-[14px]'>
      <div>
        <div className='bg-white h-[442px] pt-[50px] pl-[30px] md:h-[230px] md:pt-[29px] md:pl-[40px] lg:h-[205px] xl:h-[240px] xl:pt-[25px]'>
          <p className='text-[1.6em] tracking-[0.07em] md:text-[1.8em]'>Lorem ipsum dolor</p>
          <p className='mt-[18px] w-[88%] leading-[1.92] text-[1em] tracking-[0.026em] md:mt-[9px] md:tracking-[0.035em] md:w-[94.8%] xl:mt-[51px] xl:w-[97%] xl:tracking-[0.030em] '>
        ...
        <div className='grid md:flex md:mt-12 md:gap-[11px] lg:gap-[29px]'>
          <div className='bg-white h-[330px] pt-[63px] pl-[30px] md:h-[328px] md:w-[370px] md:pt-[30px] md:pl-[42px] lg:h-[263px] lg:pt-[27px] lg:w-[487px] xl:w-[100%] xl:h-[250px] xl:pt-[29px] xl:pl-[40px]'>
            <p className='text-[1.6em] tracking-[0.05em] md:text-[1.8em] md:tracking-wider  xl:tracking-[0.049em]'>Nulla facilisi</p>
            <p className='mt-[12px] w-[88%] leading-[1.92] text-[1em] tracking-[0.026em] lg:w-[90%] lg:tracking-[0.025em] lg:mt-[10px] xl:mt-[20px] xl:w-[91.933%]'>
          ...
          <div className='bg-white h-[360px] pt-[63px] pl-[30px] md:h-[328px] md:w-[370px] md:pt-[30px] md:pl-[42px] lg:h-[263px] lg:pt-[27px] lg:w-[487px] xl:w-[100%] xl:h-[250px] xl:pt-[29px] xl:pl-[43px]'>
