    ...
    <div className='grid justify-center mt-[20px] items-center px-[10px] md:mt-[40px] lg:mt-[62px] xl:px-[85px] xl:mt-[14px]'>
      <div>
        ...
        <div className='grid md:flex mt-[30px] md:mt-12 md:gap-[11px] lg:gap-[29px]'>
          ...
          <div className='bg-white mt-[30px] h-[360px] pt-[63px] pl-[30px] md:h-[328px] md:w-[370px] md:pt-[30px] md:pl-[42px] lg:h-[263px] lg:pt-[27px] lg:w-[487px] xl:w-[100%] xl:h-[250px] xl:pt-[29px] xl:pl-[43px]'>
